...
#PBS -S /bin/bash
#PBS -N annotate_obj
#PBS -o /beegfs/work/hd_wh241/MI_revisions/analysis/jobs/generate_ann_snrnaseq_integrated.out
#PBS -e /beegfs/work/hd_wh241/MI_revisions/analysis/jobs/generate_ann_snrnaseq_integrated.err
#PBS -q smp
#PBS -m bea
