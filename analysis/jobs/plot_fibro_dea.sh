...
$CONDA_PREFIX/bin/Rscript plot_funcomics.R \
        ...
        --dea_data_path "/net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/results/ct_data/fibro/fibroblasts_dea.rds" \
        --nfeats 15 \
        --ngenes_ORA 10 \
        --pvalue_ORA 0.15 \
        --pvalue 0.001 \
        ...
        --out_path "/net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/results/ct_data/fibro/fibroblasts";