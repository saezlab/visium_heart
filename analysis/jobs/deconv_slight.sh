...
$CONDA_PREFIX/bin/Rscript run_spotlight.R \
        ...
        --ident_var "deconv_col" \
        --folder \
        --data_path "/net/data.isilon/ag-saez/bq_shared/scellMI/processed_visium/" \
        --out_fig_file "/net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/results/deconvolution/spotlight/" \
        --out_file "/net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/results/deconvolution/spotlight/";