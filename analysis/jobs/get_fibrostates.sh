...
#SBATCH --output /net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/jobs/get_fibrostates.out
...
$CONDA_PREFIX/bin/Rscript get_cell_states.R \
        ...
        --out_fig_file "/net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/results/ct_data/fibroblasts_states.pdf" \
        --cell_class "fibroblasts" \
