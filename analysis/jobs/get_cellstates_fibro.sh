...
$CONDA_PREFIX/bin/Rscript ./analysis/2_snuc_integration_harmony/get_cell_states.R \
        ...
        --out_path "/beegfs/work/hd_wh241/MI_revisions/results/ct_data/Fib/Fib_states.rds" \
        --out_fig_file "/beegfs/work/hd_wh241/MI_revisions/results/ct_data/Fib/Fib_states.pdf" \
        --cell_class "Fib" \
        --class_label "cell_type" \
        --start_res 0.5;

$CONDA_PREFIX/bin/Rscript ./analysis/utils/h5ad_mirrors.R \
        --scell_data "/beegfs/work/hd_wh241/MI_revisions/results/ct_data/Fib/Fib_states.rds" \
        --out_file "/beegfs/work/hd_wh241/MI_revisions/results/ct_data/Fib/Fib_states.h5ad";
...
$CONDA_PREFIX/bin/Rscript ./analysis/6_atlas_comparison/get_pseudobulk_profiles.R \
        --path "/beegfs/work/hd_wh241/MI_revisions/results/ct_data/Fib/Fib_states.rds" \
        --vars "orig.ident,opt_state" \
        --collapsed "yes" \
        --out_path "/beegfs/work/hd_wh241/MI_revisions/results/ct_data/Fib/ps_Fib_states.rds" \
        --def_assay "RNA";
