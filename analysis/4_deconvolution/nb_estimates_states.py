...
sc_data = sc.read("/net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/results/integration/integrated_data_wstates.h5ad")
...
r, adata_sc_data = run_regression(sc_data, # input data object]
                   ...
                   export_args={'path': '/net/data.isilon/ag-saez/bq_rramirez/visiumMI_revisions/results/deconvolution/c2l_states/', # where to save results
                                'save_model': True, # save pytorch model?
                                'run_name_suffix': '_states'})
