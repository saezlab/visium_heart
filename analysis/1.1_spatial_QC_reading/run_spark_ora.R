...
folder <- "./visium_results_manuscript/spark"
...
gene_sets <- readRDS(file = "./markers/Genesets_Dec19.rds")[["MSIGDB_HMARKS"]]
...
spark_res %>%
  ...
  write_csv("./visium_results_manuscript/spark_annotation/spark_ora.csv", col_names = T)
