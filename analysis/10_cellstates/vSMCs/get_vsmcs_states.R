...
sc_data <- loadHDF5SummarizedExperiment("./results/ct_data/vSMCs/vSMCs_states_sce/")
...
pdf("./results/ct_data/vSMCs/qc_states.pdf")
plot(qc_panel)
dev.off()
...
all_panels <- summarize_state(ct_folder, ct_alias, 
                              ...
                              n_samples_filt, background_exclude = "vSMCs")

# Run 

mi_markers <- readRDS("./results/ct_data/vSMCs/state_genelist.rds")
...
pdf("./results/ct_data/vSMCs/label_mapping_plt.pdf", height = 4, width = 5)
