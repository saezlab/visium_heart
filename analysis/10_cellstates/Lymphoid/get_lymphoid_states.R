...
sc_data <- loadHDF5SummarizedExperiment("./results/ct_data/Lymphoid/Lymphoid_states_sce/")
...
pdf("./results/ct_data/Lymphoid/qc_states.pdf")
plot(qc_panel)
dev.off()
...
ct_alias <- "Lymphoid"
exception <- c(0, 3, 4) # Here you define the cluster to exclude 
...
mi_markers <- readRDS("./results/ct_data/Lymphoid/state_genelist.rds")
...
pdf("./results/ct_data/Lymphoid/label_mapping_plt.pdf", height = 4, width = 5)
