...
sc_data <- loadHDF5SummarizedExperiment("./results/ct_data/Myeloid/Myeloid_states_sce/")
...
pdf("./results/ct_data/Myeloid/qc_states.pdf")
plot(qc_panel)
dev.off()
...
mi_markers <- readRDS("./results/ct_data/Myeloid/state_genelist.rds")
...
pdf("./results/ct_data/Myeloid/label_mapping_plt.pdf", height = 4, width = 5)
