...
sc_data <- loadHDF5SummarizedExperiment("./results/ct_data/PC/PC_states_sce/")
...
pdf("./results/ct_data/PC/qc_states.pdf")
plot(qc_panel)
dev.off()
...
all_panels <- summarize_state(ct_folder, ct_alias, 
                              ...
                              n_samples_filt, background_exclude = "PC")

# 

mi_markers <- readRDS("./results/ct_data/PC/state_genelist.rds")
...
pdf("./results/ct_data/PC/label_mapping_plt.pdf", height = 4, width = 5)
