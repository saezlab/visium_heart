...
sc_data_file <- "./results/ct_data/endothelial/endothelial_states_sce/"
group_alias <- "state"
perc_thrsh <- 0.2
gene_filter_out <- "./results/ct_data/endothelial/gene_filter_df.rds"
n_samples_filt <- 5
pb_path <- "./results/ct_data/endothelial/ps_endothelial_states.rds"

state_prop_results <- "./results/ct_data/endothelial/state_proportion_kwtest.txt"
mlm_res <-  "./results/ct_data/endothelial/endo_state_mrks.txt"
state_gene_list <- "./results/ct_data/endothelial/state_genelist.rds"
gsea_out <- "./results/ct_data/endothelial/state_gsea.txt"
progeny_out <- "./results/ct_data/endothelial/state_progeny.txt"
de_out <- "./results/ct_data/endothelial/state_de.txt"
tf_out <- "./results/ct_data/endothelial/state_tf.txt"
all_out <- "./results/ct_data/endothelial/states_funcomics.pdf"
...
degs_ext <- read.table(mlm_res, header = T,sep = "\t") %>%
  as_tibble()
