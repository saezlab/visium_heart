...
run_state_ppline_ct(ROI_ct = "Fib",
                 ROI_prop = 0.1,
                 mask_by_prop = F,
                 mask_threshold = 0.1,
                 folder_label = "Fib_ct",
...
misty_out_folder <- "./results/state_structure/Fib_ct/"
...
run_state_ppline_ct(ROI_ct = "Fib",
                    ...
                    mask_by_prop = T,
                    mask_threshold = NULL,
                    folder_label = "Fib_ct_ms",
                    targets =  target_list,
                    target_assay = "cell_states_pos",
                    state_origin = "cell_states_ms")

misty_out_folder <- "./results/state_structure/Fib_ct_ms/"
performance_all_misty(misty_out_folder, r2_filter = 0.1)
...
#                     mask_by_prop = F,
#                     mask_threshold = 0.1,
#                     folder_label = "Fib_ct_pos",
#                     targets =  target_list,
#                     target_assay = "cell_states_pos")
# 
# misty_out_folder <- "./results/state_structure/Fib_ct_pos/"
# performance_all_misty(misty_out_folder, r2_filter = 0.1)
