...
misty_out <- "./results/state_structure/Fib_ct/"
...
misty_out <- mistyR::collect_results(folders = paste0(misty_out,"mstate_", best_performers$sample %>% unique()))
...
misty_out <- "./results/state_structure/Fib_ct_ms/"
