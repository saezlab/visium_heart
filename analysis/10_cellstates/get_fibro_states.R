...
sc_data_file <- "./results/ct_data/fibroblast/fibroblast_states_sce/"
group_alias <- "state"
perc_thrsh <- 0.2
gene_filter_out <- "./results/ct_data/fibroblast/gene_filter_df.rds"
n_samples_filt <- 5
pb_path <- "./results/ct_data/fibroblast/ps_fibroblast_states.rds"

state_prop_results <- "./results/ct_data/fibroblast/state_proportion_kwtest.txt"
mlm_res <-  "./results/ct_data/fibroblast/fibro_state_mrks.txt"
state_gene_list <- "./results/ct_data/fibroblast/state_genelist.rds"
gsea_out <- "./results/ct_data/fibroblast/state_gsea.txt"
progeny_out <- "./results/ct_data/fibroblast/state_progeny.txt"
de_out <- "./results/ct_data/fibroblast/state_de.txt"
tf_out <- "./results/ct_data/fibroblast/state_tf.txt"
all_out <- "./results/ct_data/fibroblast/states_funcomics.pdf"
