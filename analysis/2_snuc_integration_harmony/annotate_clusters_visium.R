...
#' Here we leverage the annotations of HCA and an external dataset to niches found in spatial transcriptomics
...
all_mrkrs <- readRDS("./processed_visium/integration/integrated_slides_mrkrs.rds")[["Spatial"]]
...
pdf(file = "processed_visium/integration/niche_annotation.pdf",
    width = 10,
    height = 4.5)
...
write.table(all_mrkrs, quote = F,sep = "\t",file = "processed_visium/integration/clstr_mrkrs.txt",row.names = F, col.names = T)
